...
export default class IdentityView {
    /**
     * Creates an instance of IdentityView.
    ...
    /**
     * Automatically fills form fields with identity data.
     * @param {string} customerId - The customer ID to fetch identity data for
    ...
    /**
     * Loads and displays identity details.
     * @param {string} customerId - The customer ID to load details for
     * @returns {Promise<void>}
     */
    ...
    /**
     * Displays identity details in the UI.
     * @param {Object} identity - The identity object containing user data
     * @returns {void}
     */
    ...
    /**
     * Generates the HTML for the identity header section.
     * @param {Object} identity - The identity object
     * @param {string} firstName - The first name
     * @param {string} lastName - The last name
     * @param {string} preferredUsername - The preferred username
     * @returns {string} The generated HTML string for the header
     */
    ...
    /**
     * Generates the HTML table for identity attributes.
     * @param {Object} identity - The identity object containing attributes
     * @returns {string} The generated HTML string for the attributes table
     */
    ...
    /**
     * Determines if an account can be created for the identity.
     * @param {Object} identity - The identity object to check
     * @returns {boolean} True if account can be created, false otherwise
     */
    ...
    /**
     * Groups attributes by their defined categories.
     * @param {Array} attributes - Array of attributes to group
     * @returns {Object} Object with grouped attributes by category
     */
        ...
        Object.keys(groupedAttributes).forEach(groupKey => {
            if (groupKey !== 'other') {
                groupedAttributes[groupKey].sort((a, b) => {
                    return this.identityPicker.config.attributeGroups[groupKey].attributes.indexOf(a.key) - this.identityPicker.config.attributeGroups[groupKey].attributes.indexOf(b.key);
                });
            }
        });
     ...
     * @param {number} coverage - The coverage value (0-1)
     ...
     * @param {Object} identity - The identity object containing data to fill
     * @returns {void}
     */
    fillFields(identity) {
    ...
    setupButtons(identity) {
        ...
        modifyButton?.addEventListener('click', () => {
            this.identityPicker.showIdentityFormView(identity.customer_id);
        });
    ...
    /**
     * Creates a task for an identity (account creation or email validation).
     * @param {string} customerId - The customer ID
     * @param {string} taskType - The type of task to create
     * @returns {Promise<void>}
     */
